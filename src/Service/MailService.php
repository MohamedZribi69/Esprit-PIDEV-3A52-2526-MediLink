...
class MailService
{
    ...
    /** Désactiver la vérification SSL (à réserver au dev local, ex. MAIL_VERIFY_PEER=0) */
    ...
    public function __construct()
    {
        ...
        $verifyPeer = $_ENV['MAIL_VERIFY_PEER'] ?? $_SERVER['MAIL_VERIFY_PEER'] ?? getenv('MAIL_VERIFY_PEER');
        $this->verifyPeer = $verifyPeer !== '0' && $verifyPeer !== 'false' && $verifyPeer !== '';
    }
